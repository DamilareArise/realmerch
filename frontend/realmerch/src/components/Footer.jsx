    ...
    <div className="bg-[#20052B] flex px-[50px] justify-between text-[#FFFFFF] py-[67px]">
      <div className="flex flex-col gap-[17px]">
        ...
        <span className="flex flex-col gap-[10px]">
          <Link to={""} className="text-[16px] font-[400] leading-[24px]">
            FAQ
          </Link>
          <Link to={""} className="text-[16px] font-[400] leading-[24px]">
      ...
      <div className="flex flex-col gap-[17px]">
        <p className="text-[18px] font-[500] leading-[28px]">Quick Links</p>
      ...
      <div className="flex flex-col gap-[17px]">
        <p className="text-[18px] font-[500] leading-[28px]">Company</p>
        <span className="flex flex-col gap-[10px]">
          <Link to={""} className="text-[16px] font-[400] leading-[24px]">
            About Us
          </Link>
      ...
      <div className="flex flex-col gap-[17px]">
        <p className="text-[18px] font-[500] leading-[28px]">Legal</p>
        <span className="flex flex-col gap-[10px]">
          <Link to={""} className="text-[16px] font-[400] leading-[24px]">
