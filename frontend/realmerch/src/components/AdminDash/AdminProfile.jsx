...
const AdminProfile = () => {
  ...
  return (
    <div className="bg-[#F9F2F2] flex h-screen /p-10 /rounded-lg /shadow-md /w-full /max-w-md /mx-auto">
      <div className="w-[10%]">
        <SideNav />
      </div>
      ...
      <div className="bg-white p-10 rounded-lg shadow-md /w-full max-w-md mx-auto">
